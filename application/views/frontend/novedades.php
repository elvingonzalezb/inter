			...
			<div class="col-md-9">
				<div class="m-t-25 m-b-20 m-l-10 m-r-20 p-b-20">
					<div class="wrap-title-black">
						<h1 class="mtext-113">NUEVO INGRESO DE LA SEMANA</h1>
					</div>
								...
								<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item">
									<div class="block2">
										<div class="block2-pic hov-img0">
											<a href="detalle-producto/<?php echo $value['id_producto'];?>/<?php echo $value['url_nom'];?>">
											<?php
												$imagen=$value['imagen'];
									...
									<div class="block2-txt flex-w flex-t p-t-14">
										<a class="font-weight-bold stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6" href="detalle-producto/<?php echo $value['id_producto'];?>/<?php echo $value['url_nom'];?>"><?php echo $value['codigo'];?></a>
									</div>
									<!--tit_prodt_info-->
									<!-- <a href="detalle-producto/<?php echo $value['id_producto'];?>/<?php echo $value['url_nom'];?>">Detalle</a> -->
								</div>	
								<?php endforeach ?>
							</div>
							...
							<nav aria-label="pagination example" class="paginacion clearfix">
								<ul class="pagination pg-blue">
									...
									for($w=1;$w<=$numero_paginas;$w++){
										if($w==$pagina_actual){
										    echo '<li class="page-item"><a href="novedades/'.$w.'" class="page-link active" >'.$w.'</a></li>';
										}else{
										    echo '<li class="page-item"><a href="novedades/'.$w.'" class="page-link" >'.$w.'</a></li>';
										}
									}?>
								</ul>
							</nav>
