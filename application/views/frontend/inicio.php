...
<div id="general">
    ...
    <div id="cuerpo">
    	<h1>PRODUCTOS DESTACADOS</h1>
            <div class="cont_prod_ini clearfix">
			<?php
                foreach($destacados as $destacado)
                {
					$nombre = $destacado->nombre;
					$nomUrl = formateaCadena($nombre);
					echo '<div class="prod_ini">';
						echo '<div class="prod_ini_fot">';
						echo '<img src="files/foto_producto/'.$destacado->foto.'" border="0"/>'; 
						echo '</div><!--prod_ini_fot-->';
						echo '<h2>'.$destacado->nombre.'</h2>';
						echo '<div class="botones">';
						echo '<a href="producto/'.$destacado->id_prod.'/'.$nomUrl.'"><img src="assets/frontend/'.$theme.'/imagenes/vermas.png" border="0" /></a>';
						echo '</div><!--botones-->';
					echo '</div><!--prod_ini-->';
				}
			?>
            </div><!--cont_prod_ini-->
		<h1>&Uacute;LTIMOS PRODUCTOS</h1>
            <div class="cont_prod_ini clearfix">
			<?php
                foreach($ultimos as $ultimo)
                {
					...
					echo '<div class="prod_ini">';
						echo '<div class="prod_ini_fot">';
						echo '<img src="files/foto_producto/'.$ultimo->foto.'" border="0"/>'; 
						echo '</div><!--prod_ini_fot-->';
						echo '<h2>'.$ultimo->nombre.'</h2>';
						echo '<div class="botones">';
						echo '<a href="producto/'.$ultimo->id_prod.'/'.$nomUrl.'"><img src="assets/frontend/'.$theme.'/imagenes/vermas.png" border="0" /></a>';
						echo '</div><!--botones-->';
					echo '</div><!--prod_ini-->';
				}
			?>            
