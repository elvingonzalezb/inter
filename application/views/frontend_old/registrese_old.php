                    ...
                    <div id="formulario" class="clearfix">
                        <form action="registrese/grabar" method="post" onSubmit="return valida_registro()">
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    <td colspan="3" height="50"><h3>Productos de Interes</h3></td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                        <?php 
                                        foreach ($categorias as $value) {
                                            ...
                                            if(isset($dat)){
                                                $da=explode("#",$dat['preferencias']);
                                                if(in_array($nombre,$da)){
                                                   echo '<div class="cat_registro"><input type="checkbox" name="cat_regis" value="'.$nombre.'" checked/>'.$nombre.'</div>';
                                                }else{
                                                   echo '<div class="cat_registro"><input type="checkbox" name="cat_regis" value="'.$nombre.'"/>'.$nombre.'</div>';                                                    
                                                }
                                            }else{
                                                echo '<div class="cat_registro"><input type="checkbox" name="cat_regis" value="'.$nombre.'"/>'.$nombre.'</div>';
                                            }
                                ...
                                <tr>
                                    <td><input type="hidden" name="preferencias" id="preferencias"/></td>
                                    <td></td>
                                    <td></td>
                                </tr>                                 
                                <tr>
