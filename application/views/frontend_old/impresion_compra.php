...
<div id="popupImpresion">
    ...
    <div class="tooltip-demo well">
        <div class="box-content">
            ...
            $total = redondeado($total, 3);
            ?>
                    <tr>
                        <td class="cabecera" colspan="5"></td>
                        <td class="cabecera" align="center" style="font-size:14px;">SUBTOTAL</td>
                        <td class="cabecera" align="center" style="font-size:14px;"><?php echo $simbolo.' '.$total; ?></td>
                    </tr>
                </tbody>
            </table> 
            <?php
    ...
    <table width="100%" cellspacing="1">
        ...
        <?php
            ...
            for($i=0; $i<count($aux_ca_2); $i++)
            {
                ...
                echo '<td align="center" align="center" class="celdaDato">'.$simbolo.' '.$aux_ca_3[1].'</td>';
                echo '<tr>';
            }
        ?>
            <tr>
                ...
                <td class="cabecera" align="center" style="font-size:16px;"><?php echo $simbolo.' '.number_format($total, 3, '.', ''); ?></td>
            </tr>
        </tbody>
    </table>
    <?php
