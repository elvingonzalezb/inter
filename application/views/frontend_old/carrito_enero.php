      ...
      <div id="content">
                ...
                <?php
                 ...
                 ?>
                    <div id="msgCarrito">
                        ...
                        <p>Los productos elegidos han sido agregados a su pedido. Recuerde que no serán descontados del stock hasta que haya culminado con su reserva.</p>
                    </div>
		...
		?>
                    ...
                    <td colspan="8">
                        <table width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="19%"></td>
                                <td width="19%"><input type="button" onclick="showReserva()" value="RESERVAR" class="btnReservar"></td>
                                <!--<td width="19%"><input type="button" onclick="showCompra()" value="COMPRAR" class="btnComprar"></td>-->
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <div id="formReserva">
                    ...
                    <tr>
                        <td height="20"></td>
                        <td align="left" class="tituloCarro2" colspan="2"><h1>FORMULARIO DE RESERVA</h1></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td height="20"></td>
                        <td align="left" class="subtituloCarro2">MENSAJE</td>
                        <td align="left"><textarea id="mensaje_reserva" name="mensaje_reserva" rows="5" cols="70" class="campo"></textarea></td>
                        <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td height="20" colspan="4" align="center">
                            <input type="submit" value="RESERVAR" class="btnComprar">
                        </td>
                    </tr>
                    <tr>
                ...
                <div id="formCompra">
                    ...
                    <tr>
                        <td height="20"></td>
                        <td align="left" class="tituloCarro2" colspan="2"><h1>FORMULARIO DE COMPRA</h1></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td height="20"></td>
                        <td align="left" class="subtituloCarro2">MENSAJE</td>
                        <td align="left"><textarea id="mensaje_compra" name="mensaje_compra" rows="5" cols="70" class="campo"></textarea></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td colspan="4" height="10"></td>
                    ...
                    <tr>
                        <td height="20"></td>
                        <td align="left" colspan="2">Favor indicar la forma de pago antes de confirmar su compra.</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td colspan="4" height="10"></td>
                    ...
                    <tr>
                        <td height="20"></td>
                        <td align="left" class="subtituloCarro2">FORMA DE PAGO</td>
                        <td align="left">
                            <input type="radio" name="forma_pago" value="transferencia"> Transferencia Bancaria
                            <br>
