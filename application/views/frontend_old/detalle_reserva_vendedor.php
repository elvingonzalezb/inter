      ...
      <div id="content">
        <div class="wrap-featured-products">
            <div class="wrap-title-black">
              <h1 class="nice-title">Detalle de Reserva de Vendedor</h1>
            </div>
            <div class="contenido">
            <?php
                if($resultado==0)
            ...
            ?>
                    ...
                    <div class="box-content">
                        <table width="100%" cellspacing="1">
                            ...
                            foreach($detalles as $detalle)
                            {
                                ...
                                {
                                    $ci =& get_instance();
                                    $fecha_llegada = $ci->Pedido_model->getFechaLlegada($detalle->id_producto, $detalle->id_color);
               ...
               <div id="botoneraDetalleCompra">
                   ...
                   <div id="btnsIzq2">
                       <a href="javascript:printReservaVendedor(<?php echo $orden->id_orden; ?>, <?php echo $id_vendedor; ?>)" class="btnRojo">IMPRIMIR</a></div>
                   <div id="btnsDer"></div>
