      ...
      <div id="content">
        <div class="wrap-featured-products">
            <div class="wrap-title-black">
                <h1 class="nice-title"><?php echo formatoFechaProximamente2($fecha); ?></h1>
            </div>
            <div class="contenido">
            <?php
            ...
            <?php
                ...
                for($w=1;$w<=$numero_paginas;$w++)
                {
                    if($w==$pagina_actual)
                    {
                        echo '<li><a href="proximos-ingresos/'.$fecha.'/'.$w.'" class="actual">'.$w.'</a></li>';
                    }
                    else
                    {
                        echo '<li><a href="proximos-ingresos/'.$fecha.'/'.$w.'" >'.$w.'</a></li>';
                    }
                }
                ?>
                </ul>
