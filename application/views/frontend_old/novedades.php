      ...
      <div id="content">
        <div class="wrap-featured-products">
            <div class="wrap-title-black">
              <h1 class="nice-title"><?php echo $novedades->titulo; ?><?php //echo $acerca_nosotros->titulo;?></h1>
            </div>
            <div class="contenido">
                <div class="paginacion clearfix">
                    <ul>
                        ...
                        for($w=1;$w<=$numero_paginas;$w++){
                            if($w==$pagina_actual){
                                echo '<li><a href="novedades/'.$w.'" class="actual">'.$w.'</a></li>';
                            }else{
                                echo '<li><a href="novedades/'.$w.'">'.$w.'</a></li>';
                            }
                        }?>
                    </ul>
                </div><!--paginacion-->                
