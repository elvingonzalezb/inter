            ...
            ?>
                ...
                <form method="post" action="reservas/doCompraMultiple" onsubmit="return valida_compra()">
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td height="10"></td>
                            <td align="left" valign="middle" class="dato">CODIGOS DE RESERVAS</td>
                            <td align="left" valign="middle" class="dato"><?php echo $codigos; ?></td>
                            <td></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td height="10"></td>
                            <td align="left" valign="middle" class="dato">MONTO TOTAL A PAGAR</td>
                            <td align="left" valign="middle" class="dato"><?php echo $simbolo.' '.$monto_total; ?></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="4" height="10"></td>
                        ...
                        <tr>
                            ...
                            <td width="40%" class="dato">FORMA DE PAGO</td>
                            <td width="50%">
                        ...
                        <tr>
                            ...
                            <td><textarea name="observaciones" rows="4" cols="40" id="observaciones"></textarea></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="4" height="10"></td>
