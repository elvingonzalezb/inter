...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-edit"></i> Nuevo Boletin de Novedades</h2>
            <div class="box-icon">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="mainpanel/boletin/grabar" method="post" enctype="multipart/form-data">
                <fieldset>
                    <legend>Ingrese los datos del nuevo boletin</legend>
                    <?php
                        if( isset($resultado) )
                        {
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <div id="elejidos_colores" >
                                ...
                                <input type="hidden" id="productos_elegidos" name="productos_elegidos">
                            </div>
                        </div>
                    </div>
