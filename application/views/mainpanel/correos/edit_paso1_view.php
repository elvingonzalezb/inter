...
<div class="row-fluid sortable">
    ...
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-user"></i> EDITAR CORREO A CLIENTES - PASO 1: ELIJA LOS DESTINATARIOS</h2>
            <div class="box-icon">
        ...
        <div class="box-content">
            <form method="post" action="mainpanel/correos/editPaso2" onsubmit="return valida_paso1()">
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                ...
                <tbody>
                <?php
                    $lista_destinatarios = explode("##", $destinatarios);
                    $elegidos = array();
                    for($i=0; $i<count($clientes); $i++)
                    {
                        ...
                        if(in_array($id_cliente, $lista_destinatarios))
                        {
                            $elegidos[] = $id_cliente;
                            echo ' <input type="checkbox" name="del" value="'.$id_cliente.'" id="'.$id_cliente.'" checked onclick="concatena('.$id_cliente.')">';  
                        }
                        else 
                        {
                ...
                <tbody>
                    <tr>
                        <td width="100%" align="center" class="center">
                            <input type="hidden" name="id" id="id" value="<?php echo $id_boletin; ?>">
                            <input type="text" id="id_eliminar" name="id_eliminar" value="<?php echo implode("##", $elegidos); ?>">
