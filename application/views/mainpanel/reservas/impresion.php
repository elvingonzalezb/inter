        ...
        <table width="100%" cellpadding="0" cellspacing="2">
            <thead>
                <tr>
                    ...
                    <th width="23%" align="center" valign="middle" class="cabecera">Nombre del Producto</th>
                    <th width="10%" align="center" valign="middle" class="cabecera">Color</th>
                    <th width="13%" align="center" valign="middle" class="cabecera">Nombre Color</th>
                    <th width="13%" align="center" valign="middle" class="cabecera">Precio</th>
                    <th width="13%" align="center" valign="middle" class="cabecera">Cantidad</th>
                    <th width="13%" align="center" valign="middle" class="cabecera">Subtotal</th>
                </tr>
            </thead>   
            <tbody>
            <?php
                ...
                echo '<tr>';
                echo '<td class="celdaDato" align="center">'.$detalle->codigo_producto.'</td>';                        
                echo '<td class="celdaDato">'.$detalle->nombre_producto.'</td>';
                echo '<td class="celdaDato"><div style="background:'.$detalle->codigo_color.';margen:15px;width:50px;height:50px;border:#000 solid 1px;"></td>';
                echo '<td class="celdaDato">'.$detalle->nombre_color.'</td>';
                echo '<td class="celdaDato" align="center">'.$simbolo.' '.$precio.'</td>';
                echo '<td class="celdaDato" align="center">'.$detalle->cantidad.'</td>';
                echo '<td class="celdaDato" align="center">'.$simbolo.' '.$subtotal.'</td>';
                echo '</tr>';
            ...
            ?>
            <tr>
                <td align="center" valign="middle" class="cabecera" colspan="5"></td>
                <td align="center" valign="middle" class="cabecera"><strong>SUBTOTAL</strong></td>
                <td align="center" valign="middle" class="cabecera"><strong><?php echo $simbolo.' '.$total; ?></strong></td>
            </tr>
            </tbody>
        </table> 
<?php
...
<table width="100%" cellpadding="0" cellspacing="2">
    ...
    <?php
        foreach($cargos as $cargo)
        {
            ...
            $total += $monto;
            echo '<tr>';
            echo '<td colspan="2" class="celdaDato" align="center">'.$concepto.'</td>';
            echo '<td class="celdaDato" align="center">'.$simbolo.' '.$monto.'</td>';
            echo '<tr>';
        }
    ?>
        <tr>
