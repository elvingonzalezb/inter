<?php
	...
	echo '<thead>';
	echo '<tr>';
		echo '<td height="30" align="center" valign="middle" style="background-color:#FF9;">NRO</td>';
		echo '<td align="center" valign="middle" style="background-color:#FF9;">CODIGO</td>';                
                $cont=0;
                $foto_ver=  getConfig("mostrar_imagen");
                if($foto_ver=='si'){
                    echo '<td align="center" valign="middle" style="background-color:#FF9;">FOTO</td>';                    
                    $cont +=1;
                }
                ...
                foreach($familias as $fam)
                {
                    ...
                    echo '<td align="center" valign="middle" style="background-color:#FF9;">'.$currentFam.'</td>';
                    $cont +=1;
                }
		echo '<td align="center" valign="middle" style="background-color:#FF9;">PRECIOS</td>';                
                echo '<td align="center" valign="middle" style="background-color:#FF9;">ULTIMA ACTUALIZACION</td>';                    
	echo '</tr>';
	echo '</thead>';
