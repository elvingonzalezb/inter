...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-edit"></i> Editar Banner de Cliente</h2>
            <div class="box-icon">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="mainpanel/banners/actualizarc" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="span6"><img src="files/banner_clientes/<?php echo $banner->imagen; ?>" /></div>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            ...
                            <p>La imagen a subir debe tener dimensiones de 720 x 180 pixeles. Caso contrario la imagen se forzará al tamaño indicado.</p>
                            </div> 
                        </div>
                    </div>                    
                    <div class="control-group">
