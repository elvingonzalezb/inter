...
<div class="row-fluid sortable">
    ...
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-user"></i> Banners de Usuarios</h2>
            <div class="box-icon">
        ...
        <div class="box-content">
            <table class="table table-striped table-bordered bootstrap-datatable datatable" data-url="banners/ajaxListaBanners">
                <thead>
                    <tr>
                        <th width="5%">Nro</th>
                ...
                <?php
                    ...
                    {
                        $pic = '<img src="files/banner/'.$banner->imagen.'" />';
                        echo '<tr>';
                        ...
                        echo '<td>';
                        echo '<a class="btn btn-success" href="javascript:showBanner(\''.$banner->imagen.'\', \''.$banner->titulo.'\')"><i class="icon-zoom-in icon-white"></i>  Ver</a> ';
