...
<div class="row-fluid sortable">
    ...
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-user"></i> Clientes Anulados <a href="mainpanel/clientes/excel/anulados" target="_blank">[DESCARGAR EXCEL]</a></h2>
            <div class="box-icon">
        ...
        <div class="box-content">
            <table class="table table-striped table-bordered bootstrap-datatable datatable" data-url="clientes/ajaxListaClientes/anulados">
                <thead>
                    <tr>
                        <th width="5%">Nro</th>
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    <tr>
                        <td width="30%"></td>
                        <td width="40%">
                            <a class="btn btn-danger" href="javascript:deleteMultiCliAnulados()"><i class="icon-trash icon-white"></i>Eliminar Definitivamente los Seleccionados</a>
