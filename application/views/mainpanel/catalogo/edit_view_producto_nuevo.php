...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="mainpanel/catalogo/actualizar_producto" method="post" enctype="multipart/form-data" onsubmit="return valida_producto4()">
                <fieldset>
                    ...
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Categor&iacute;a Principal</label>
                        <div class="controls">
                            <select name="id_categoria_principal" id="id_categoria_principal" onchange="cargaSubcats2(this.value)">
                                ...
                                for($i=0; $i<count($categorias); $i++)
                                {
                                    ...
                                    if(isset($selectCat->id_categoria) && $selectCat->id_categoria==$id_categoria_padre){
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls" id="divCategoriasPrincipal">
                            <select name="id_categoria" id="id_categoria">
                                <option value="0">Elija...</option>
                                <?php 
                                foreach ($subcategorias as $key => $value) {
                                    if(isset($selectCat->id_subcategoria) && $selectCat->id_subcategoria==$value->id_subcategoria){
                                        echo '<option value="'.$value->id_subcategoria.'" selected>'.$value->nombre.'</option>';
                                    }else {
                    ...
                    <div class="control-group warning">
                        ...
                        <div class="controls">
                         <span class="help-inline"><?php echo Ymd_2_dmY($producto->actualizacion); ?></span>
                        </div>
                    </div><!--control-group-->                  
