...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="mainpanel/catalogo/grabar_producto" method="post" enctype="multipart/form-data" onsubmit="return valida_producto3()">
                <fieldset>
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <div id="elejidos_colores" >
                                <h3>SUBCATEGORIAS SECUNDARIAS</h3>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                        <label class="radio">
                            <input type="radio" name="show_stock" value="1" checked />Si
                         </label>
                         <div style="clear:both"></div>
                         <label class="radio">
                            <input type="radio" name="show_stock" value="0" />No                            
                         </label>
                        </div>
                    </div>                     
