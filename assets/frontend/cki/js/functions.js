...
function modificarReserva(id_reserva) {
    ...
    str = '<a href="#" class="btn btn-secondary btn-sm" data-dismiss="modal">CANCELAR</a>';
    str += '<a href="reservas/modificar/'+id_reserva+'" class="btn btn-primary btn-sm">MODIFICAR</a>';
...
/*$(document).ready(function(){
    ...
    var scrollDesing = document.getElementById("scrollDesing");
    
    $(".navScroll").on('click', function(){
    
        scrollDesing.scrollTop += this.id === 'scrollDown' ? 10 : -10;
